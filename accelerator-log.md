...
```json
{
  "projectName" : "tanzu-test-java-web-app",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-test-java-web-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: tanzu-test-java-we...(truncated)]
